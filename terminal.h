...
#define TERM_DEFAULT (term_color_t){0, 0, 0, true}
#define TERM_BLACK (term_color_t){0, 0, 0, false}
#define TERM_WHITE (term_color_t){255, 255, 255, false}
#define TERM_RED (term_color_t){255, 0, 0, false}
#define TERM_GREEN (term_color_t){0, 255, 0, false}
#define TERM_YELLOW (term_color_t){255, 255, 0, false}
#define TERM_BLUE (term_color_t){0, 0, 255, false}
#define TERM_MAGENTA (term_color_t){255, 0, 255, false}
#define TERM_CYAN (term_color_t){0, 255, 255, false}
